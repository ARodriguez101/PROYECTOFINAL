<!-- Header, sesion de usuario y menu -->
...
<div class="container">
  <div class="row">
	...
	?><div class="row">    
			...
			<!-- Eliminar amigo -->
				<div class="col-md-10">
					<div class="pull-right"><p></p><a href="delete_friend.php<?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="icon-remove"></i>  Eliminar amigo</a></div>
