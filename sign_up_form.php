                            ...
                            <form  action="signup_save.php" method="post" autocomplete="on"> 
								...
								<hr>
                                <p> 
                                    <label for="usernamesignup" class="uname">Tu usuario</label>
								...
								<p> 
                                    <label for="passwordsignup" class="youpasswd">Nombre </label>
                                    <input id="passwordsignup" name="firstname" required="required" type="text" placeholder="Tu nombre"/>
                                </p>
								<p> 
                                    <label for="passwordsignup" class="youpasswd">Apellido </label>
                                    <input id="passwordsignup" name="lastname" required="required" type="text" placeholder="Apellido"/>
                                </p>
								<p> 
                                    <label for="passwordsignup" class="youpasswd">Tu género </label>
